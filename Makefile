# ===================
# Gavin lyons 11-2024
# Makefile to install library for ST7789_TFT_RPI library.
...
LIBDIR=$(PREFIX)/lib
# library name , linker flag -lrpist7789gl
LIB=librpist7789gl
# shared library name
LIBNAME=$(LIB).so.1.0
...
uninstall:
	...
	@rm -vf  $(LIBHEADERDIR)*_data_RVL.hpp
	@rm -vf  $(LIBHEADERDIR)*_graphics_RVL.hpp
	@rm -vf  $(LIBHEADERDIR)*_LCD_RVL.hpp
	@echo "******************"
