...
rvlDisplay_Return_Codes_e display_Fonts::setFont(display_Font_name_e FontChoice)
{
	...
	{
	case font_default:
		SelectedFontName = pFontDefault;
		break;
	case font_pico:
		SelectedFontName = pFontPico;
		break;
	case font_sevenSeg:
		SelectedFontName = pFontSevenSeg;
		break;
	case font_thick:
		SelectedFontName = pFontThick;
		break;
	case font_wide:
		SelectedFontName = pFontWide;
		break;
	case font_sinclairS:
		SelectedFontName = pFontSinclairS;
		break;
	case font_orla:
		SelectedFontName = pFontOrla;
		break;
	case font_retro:
		SelectedFontName = pFontRetro;
		break;
	case font_mega:
		SelectedFontName = pFontMega;
		break;
	case font_arialBold:
		SelectedFontName = pFontArialBold;
		break;
	case font_hallfetica:
		SelectedFontName = pFontHallfetica;
		break;
	case font_arialRound:
		SelectedFontName = pFontArialRound;
		break;
	case font_groTesk:
		SelectedFontName = pFontGroTesk;
		break;
	case font_mint:
		SelectedFontName = pFontMint;
		break;
	/*
case font_sixteenSeg:
	SelectedFontName = pFontSixteenSeg;
	break;
	*/
	case font_SpaceMonoBold:
		SelectedFontName = pSpaceMonoBold;
		break;
	default:
...
/*!
	Font type: Space Mono Bold
	Font size: x16 pixels
	This is a clear reading sixteen-segment font with some special symbols / . - :
*/
static const uint8_t SpaceMonoBold[2482] = {
	0x0A,
	0x08,
	0x3D,
	0x80,
...
const uint8_t *pSpaceMonoBold = SpaceMonoBold;
// === End of Font Data ===
