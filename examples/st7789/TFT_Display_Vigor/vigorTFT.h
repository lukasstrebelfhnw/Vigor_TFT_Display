...
public:
  ...
  void createTextBox(int16_t x, int16_t y, const uint8_t font, uint16_t textColor, std::string text);
  void createTextBox(int16_t x, int16_t y, const uint8_t font, uint16_t textColor, uint16_t toggleTextColor, std::string text, bool toggleColor);
  // Set Bitmap Picture
